...
const Signup = () => {
    ...
    return (
        <div className="flex items-center justify-center max-w-7xl mx-auto">
            <form onSubmit={formik.handleSubmit} className="w-1/2 border border-gray-200 rounded-md p-4 my-10">
                ...
                {/* Submit Button */}
                <button type="submit" className="w-full my-4 bg-blue-600 text-white py-2 rounded-md" disabled={formik.isSubmitting || loading}>
                    {formik.isSubmitting || loading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : "Signup"}
                </button>
